...
class RoleAbilitiesService
{
    ...
    public static function getAbilities($role)
    {
        $roleAbilities = [
            'Administrator' => ['*'],
            'Teacher' => ['view-parents', 'delete-attendance', 'update-attendance', 'view-attendance', 'create-attendance', 'update-section-progress', 'grade-student', 'changePassword', 'score-quiz-submission', 'check-quiz-submissions', 'section-student-linked','send-sms', 'get-announcement',  'post-announcement', 'delete-announcement', 'view-students', 'grade-students', 'update-profile', 'subject-assign-student', 'class-assign-student', 'create-lesson',
        'view-lessons', 'update-announcement', 'create-section-assessment', 'view-classes', 'update-lessons', 'delete-lessons','create-section', 'view-section', 'update-section', 'view-classes-all', 'add-student-lessons', 'update-lesson-progress', 'update-section-progress'],
            ...
            'Parent' => ['view-parents', 'changePassword', 'read-only', 'view-students-parent', 'section-student-linked'. 'get-announcement'],
        ];
