...
class RoleAbilitiesService
{
    ...
    public static function getAbilities($role)
    {
        $roleAbilities = [
            'Administrator' => ['*'],
            'Teacher' => ['grade-dropbox-submission',  'view-dropbox-submissions', 'section-student-linked', 'view-parents', 'delete-attendance', 'update-attendance', 'view-attendance', 'create-attendance', 'update-section-progress', 'grade-student', 'changePassword', 'score-quiz-submission', 'check-quiz-submissions', 'section-student-linked','send-sms', 'get-announcement',  'post-announcement', 'delete-announcement', 'view-students', 'grade-students', 'update-profile', 'subject-assign-student', 'class-assign-student', 'create-lesson',
        'view-lessons', 'update-announcement', 'create-section-assessment', 'grade-dropbox-submission', 'view-classes', 'update-lessons', 'delete-lessons','create-section', 'view-section', 'update-section', 'view-classes-all', 'add-student-lessons', 'update-lesson-progress', 'update-section-progress'],
            'Student' => ['view-parents', 'view-dropbox-submissions', 'view-own-attendance', 'update-section-progress', 'changePassword', 'section-student', 'section-student-linked', 'submit-quiz-answer', 'section-student', 'get-announcement',  'view-grades', 'update-profile', 'answer-module', 'view-classes', 'view-lessons', 'view-section', 'update-section', 'view-classes-all', 'update-lesson-progress', 'update-section-progress'],
            'Parent' => ['view-own-attendance', 'section-student-linked', 'view-parents', 'changePassword', 'read-only', 'view-students-parent', 'get-announcement'],
        ];
